...
s.pack(side=LEFT, fill=Y) # creats a scroll layer on LEFT side but wont scroll
s.config(command=T.yview)# now it will scroll but if we release scroller it will go back to starting
